...
svn_update()
{
    ...
    svn update # helps to fight Skipped '/home/mor' when /home/mor is symlink
...
if [ -z "$1" ];
	then
		...
		/bin/echo -e "search kolmisoft.com\nnameserver 192.168.0.1\nnameserver 8.8.8.8" > /etc/resolv.conf
		...
		echo "Checking MOR X4"
		SVN_PATH="http://svn.kolmisoft.com/mor/gui/branches/x4"
		...
		/usr/src/mor/upgrade/x4/assets_recompile.sh
                /etc/init.d/httpd start
