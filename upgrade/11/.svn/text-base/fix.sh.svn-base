...
report "Adding symlinks to /usr/src/mor/upgrade/11/gui_upgrade_light.sh and /usr/src/mor/upgrade/11/gui_upgrade.sh" 3
ln -s /usr/src/mor/upgrade/11/gui_upgrade_light.sh /home/mor/gui_upgrade_light.sh
ln -s /usr/src/mor/upgrade/11/gui_upgrade.sh /home/mor/gui_upgrade.sh
...
cp -fr /usr/src/mor/asterisk-conf/11/extensions_mor_callingcard.conf /etc/asterisk/
...
# cronjobs
cp -fr /usr/src/mor/upgrade/11/cronjobs/mor_daily_actions /etc/cron.d/
cp -fr /usr/src/mor/upgrade/11/cronjobs/mor_minute_actions /etc/cron.d/
