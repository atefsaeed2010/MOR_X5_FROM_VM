INSERT INTO conflines (name,value,owner_id) SELECT 'MOR_11_extend', 1, 0 FROM dual WHERE (SELECT COUNT(*) FROM conflines WHERE name = 'MOR_11_extend') = 0;
...
CREATE TABLE ivr_action_logs (id INT NOT NULL AUTO_INCREMENT ,created_at DATETIME NULL ,action_text VARCHAR( 255 ) NULL ,uniqueid VARCHAR( 30 ) NULL ,adnumber_id INT NULL ,PRIMARY KEY ( id )) ENGINE = InnoDB ;
